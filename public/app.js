...
function certViewFull(courseId){
  ...
  <div class="cert-modal" id="certModalCard">
    <div class="cert-modal-actions">
      ...
      <button class="cert-action-btn" title="Print" onclick="(function(){var s=document.createElement('style');s.id='certPrintStyle';s.textContent='@page{size:A4 landscape;margin:0}@media print{body>*{display:none!important}body>#certModalOverlay{display:flex!important;position:fixed!important;inset:0!important;padding:0!important;background:#0d0c18!important}#certModalOverlay .cert-modal{max-width:none!important;width:100%!important}#certModalOverlay .cert-modal-actions{display:none!important}#certModalOverlay .cert-full{width:297mm!important;height:210mm!important;aspect-ratio:auto!important;border-radius:0!important;flex-shrink:0!important}html,body{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important;background:#0d0c18!important}}';document.head.appendChild(s);window.print();setTimeout(function(){var e=document.getElementById('certPrintStyle');if(e)e.remove();},1000);})()" >⎙ Print</button>
