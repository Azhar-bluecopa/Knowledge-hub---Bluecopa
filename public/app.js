...
function certViewFull(courseId){
  ...
  <div class="cert-modal" id="certModalCard">
    <div class="cert-modal-actions">
      ...
      <button class="cert-action-btn" title="Print" onclick="(function(){const c=document.querySelector('.cert-full');const lnk=document.querySelector('link[href*=\'style.css\']');const href=lnk?lnk.href:'/style.css';const w=window.open('','_blank','width=1200,height=900');w.document.write('<html><head><title>Certificate — Bluecopa</title><link rel=\'stylesheet\' href=\''+href+'\'><style>*{box-sizing:border-box;}body{margin:0;padding:0;display:flex;align-items:center;justify-content:center;min-height:100vh;background:#080d12;}.cert-full{width:297mm;height:210mm;border-radius:0!important;flex-shrink:0;}@page{size:A4 landscape;margin:0;}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact;background:#080d12;}}</style></head><body>'+c.outerHTML+'</body></html>');w.document.close();w.focus();setTimeout(function(){w.print();},800);})()">⎙ Print</button>
