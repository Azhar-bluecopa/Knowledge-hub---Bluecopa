...
function certViewFull(courseId){
  ...
  <div class="cert-modal" id="certModalCard">
    <div class="cert-modal-actions">
      ...
      <button class="cert-action-btn" title="Print" onclick="(function(){var c=document.querySelector('.cert-full');var lnk=document.querySelector('link[href*=\'style.css\']');var href=lnk?lnk.href:'/style.css';var ifr=document.createElement('iframe');ifr.style.cssText='position:fixed;left:-9999px;top:-9999px;width:0;height:0;border:0;';document.body.appendChild(ifr);var d=ifr.contentDocument||ifr.contentWindow.document;d.open();d.write('<html><head><title>Certificate<\/title><link rel=\'stylesheet\' href=\''+href+'\'><style>*{box-sizing:border-box}html,body{margin:0;padding:0;display:flex;align-items:center;justify-content:center;min-height:100vh;background:#0d0c18}.cert-full{width:297mm!important;height:210mm!important;border-radius:0!important;flex-shrink:0!important}@page{size:A4 landscape;margin:0}@media print{html,body{-webkit-print-color-adjust:exact;print-color-adjust:exact;background:#0d0c18!important}}<\/style><\/head><body>'+c.outerHTML+'<\/body><\/html>');d.close();setTimeout(function(){ifr.contentWindow.focus();ifr.contentWindow.print();setTimeout(function(){if(document.body.contains(ifr))document.body.removeChild(ifr)},2000)},1500);})()" >⎙ Print</button>
